export const caseStudies = [
  {
    ...
    solution:
      'FinXT provided end-to-end programme management across all four markets. We recruited and screened over 1000+ participants against defined eligibility criteria, coordinated session scheduling and venue setup across locations, managed day-of-session operations, and disbursed participant rewards in local currencies within 48 hours of each session.',
    outcomes: [
      '1000+ screened and confirmed participants across 4 countries',
  ...
  },
  {
    ...
    solution:
      'FinXT deployed its Employer of Record service across the relevant jurisdictions, managing employment contracts, local payroll, and statutory compliance for the deployed team. The client had compliant, operationally ready staff in all three markets within the required timeframe.',
    outcomes: [
  ...
  },
  {
    ...
    solution:
      'FinXT deployed its crowdsourcing and participant management infrastructure to recruit, screen, and schedule participants at scale, managing eligibility screening, session confirmations, no-show mitigation protocols, and same-day replacement procedures to protect session fill rates.',
    outcomes: [
